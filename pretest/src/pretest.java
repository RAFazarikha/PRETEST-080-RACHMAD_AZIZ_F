...
public class pretest extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setLabelFor(fnama);
        jLabel1.setText("Nama :");
        jPanel1.add(jLabel1);

        fnama.setFont(new java.awt.Font("Poppins Medium", 0, 18)); // NOI18N
        jPanel1.add(fnama);
        ...
        jLabel2.setLabelFor(fnilai);
        jLabel2.setText("Nilai :");
        jPanel1.add(jLabel2);

        fnilai.setFont(new java.awt.Font("Poppins Medium", 0, 18)); // NOI18N
        jPanel1.add(fnilai);

        btnsimpan.setFont(new java.awt.Font("Poppins Medium", 0, 18)); // NOI18N
    ...
    private void btnsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsimpanActionPerformed
        ...
        if (fnama.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Nama Tidak Boleh Kosong", "Masukkan Nama", JOptionPane.ERROR_MESSAGE);
        }else{
            int nilai = Integer.parseInt(fnilai.getText()); 
            JOptionPane.showMessageDialog(null, "Mahasiswa " +fnama.getText() +" Dengan Nilai " +fnilai.getText() +" Telah Disimpan");
        }
